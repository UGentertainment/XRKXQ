...
Bitmap.prototype.getPixel = function(x, y) {
    try {
        ...
        // A sandboxed cross-origin iframe can make an otherwise displayable
        // image unreadable to Canvas. Keep window/text rendering alive.
        return '#ffffff';
    }
    var result = '#';
    for (var i = 0; i < 3; i++) {
...
Bitmap.prototype._requestImage = function(url){
    ...
    this._image = new Image();
    // The platform runs this page under an opaque sandbox origin. GitHub
    // Pages sends Access-Control-Allow-Origin: *, so anonymous CORS keeps
    // canvases readable after drawing external image resources.
